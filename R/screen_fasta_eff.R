#' A efficient function to identify sites of interestes from a list of longitudinal sequence file.
#'
...
screen_fasta_eff=function(file_list,ref=NULL,priorPA=.001){
